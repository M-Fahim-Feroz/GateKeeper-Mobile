...
interface BlocklistSubscriptionDao {
    ...
    @Query("UPDATE blocklist_subscriptions SET lastRefreshedAt = :ts, domainCount = :count WHERE id = :id")
    suspend fun updateRefreshTime(id: String, ts: Long, count: Int): Int
